...
int n_props;  //= m_props
int iv,ik,it,ie, iw, igofr;  //indici nell'array di misure
double walker[m_props];

// averages
double blk_av[m_props],blk_norm;
double glob_av[m_props],glob_av2[m_props];
double stima_pot, stima_ekin, stima_etot, stima_temp, stima_press, stima_g;  //averages.cpp
//double stima_pot_inst, stima_ekin_inst, stima_etot_inst, stima_temp_inst;  //con_eq3.cpp
double err_pot,err_ekin,err_etot,err_temp, err_press, err_gdir;
